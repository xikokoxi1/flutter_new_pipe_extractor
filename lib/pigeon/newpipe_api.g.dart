...
class NewPipeExtractor {
  /// Constructor for [NewPipeExtractor].  The [binaryMessenger] named argument is
  /// available for dependency injection.  If it is left null, the default
  /// BinaryMessenger will be used which routes to the host platform.
  NewPipeExtractor({BinaryMessenger? binaryMessenger, String messageChannelSuffix = ''})
  ...
  Future<void> init() async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.flutter_new_pipe_extractor.NewPipeExtractor.init$pigeonVar_messageChannelSuffix';
  ...
  Future<JsonMessageMap> getVideoInfo(String videoId) async {
    ...
    final List<Object?>? pigeonVar_replyList =
        await pigeonVar_channel.send(<Object?>[videoId]) as List<Object?>?;
    if (pigeonVar_replyList == null) {
      throw _createConnectionError(pigeonVar_channelName);
    } else if (pigeonVar_replyList.length > 1) {
      throw PlatformException(
  ...
  Future<List<JsonMessageMap>> search(String query, {List<String>? contentFilters, String? sortFilter, }) async {
    ...
    final List<Object?>? pigeonVar_replyList =
        await pigeonVar_channel.send(<Object?>[query, contentFilters, sortFilter]) as List<Object?>?;
    if (pigeonVar_replyList == null) {
      throw _createConnectionError(pigeonVar_channelName);
    } else if (pigeonVar_replyList.length > 1) {
      throw PlatformException(
